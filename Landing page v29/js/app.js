...
document.addEventListener('scroll', function (event) {
	...
	if (window.scrollY < 800) { // or any other filtering condition  
		...
		var highlightSection = document.getElementsByClassName("section")[0];
		highlightSection.className += " active";
		var current = document.getElementsByClassName("buttonStyle")[0];
		current.className += " active";

	} else if (window.scrollY >= 801 && window.scrollY < 1199) {
		var highlightSection = document.getElementsByClassName("section")[1];
		highlightSection.className += " active";
		...
		var highlightSection = document.getElementsByClassName("section")[2];
		highlightSection.className += " active";

		var current = document.getElementsByClassName("buttonStyle")[2];
		current.className += " active";
	}
	else if (window.scrollY >= 1801) {
		var highlightSection = document.getElementsByClassName("section")[3];
		highlightSection.className += " active";
